...
{
    /// <summary>
    /// Unit tests for the CarCreateViewModel
    /// </summary>
    [TestClass]
    public class CarCreateViewModelTests
    {
        ...
        [TestMethod]
        public void CarCreateViewModel_AllProperties_Valid()
        {
            // Arrange
        ...
        [TestMethod]
        public void Car_Image_Required()
        {
            // Arrange
            var viewModel = new CarCreateViewModel
            {
            ...
            Assert.IsFalse(isValid);
            Assert.AreEqual(1, results.Count);
            Assert.AreEqual("Please select an image.", results[0].ErrorMessage);
        }
